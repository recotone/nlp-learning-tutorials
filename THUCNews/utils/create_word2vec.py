...
if __name__ == '__main__':
    ...
    THUCNews_path = "F:\技术资料\舆情食材\THUCNews"
    # 读取所有文件列表
    ...
    # 将数据划分为train val数据集
    train_files, train_label, val_files, val_label = files_processing.split_train_val_list(files_list, label_list,
                                                                                           facror=0.9, shuffle=True)
    ...
    # word2vec_path = 'out/trained_word2vec.model'
    train_out_dir = r'..\data\train_data'
    prefix = 'train_data'
    batchSize = 20000
